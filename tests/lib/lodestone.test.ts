  ...
  describe("endpoint", () => {
    ...
    describe("character", () => {
      ...
      describe("find", () => {
        it("errors if invalid parameters", async () => {
          ...
          await expect(
            lodestone.character.find({ dcname: "", q: "" })
          ).rejects.toThrow();
        });
    ...
    describe("cwls", () => {
      describe("get", () => {
        ...
        it("returns an object for a valid identifier", async () => {
          const result = await lodestone.cwls.get(
            "e4d9a64fa0316b8ebe701e818b0a6b8e7be61d2c"
          );
      ...
      describe("find", () => {
        it("errors if invalid parameters", async () => {
          ...
          // @ts-expect-error - invalid parameter
          await expect(
            lodestone.cwls.find({ q: "", worldname: "" })
          ).rejects.toThrow();
        });

        it("returns an array of objects for the query", async () => {
          const results = await lodestone.cwls.find({
            dcname: "_dc_Light",
            q: "",
          });
    ...
    describe("freecompany", () => {
      ...
      describe("find", () => {
        it("errors if invalid parameters", async () => {
          ...
          // @ts-expect-error - invalid parameter
          await expect(
            lodestone.freecompany.find({ dcname: "", q: "" })
          ).rejects.toThrow();
        });

        it("returns an array of objects for the query", async () => {
          const results = await lodestone.freecompany.find({
            q: "",
            worldname: "Raiden",
          });
    ...
    describe("linkshell", () => {
      ...
      describe("find", () => {
        it("errors if invalid parameters", async () => {
          ...
          // @ts-expect-error - invalid parameter
          await expect(
            lodestone.linkshell.find({ dcname: "", q: "" })
          ).rejects.toThrow();
        });

        it("returns an array of objects for the query", async () => {
          const results = await lodestone.linkshell.find({
            q: "",
            worldname: "Raiden",
          });
    ...
    describe("pvpteam", () => {
      describe("get", () => {
        ...
        it("returns an object for a valid identifier", async () => {
          const result = await lodestone.pvpteam.get(
            "2ab412c104fdcd9c1e43e384bf7e8503d34a645b"
          );
      ...
      describe("find", () => {
        it("errors if invalid parameters", async () => {
          ...
          // @ts-expect-error - invalid parameter
          await expect(
            lodestone.pvpteam.find({ q: "", worldname: "" })
          ).rejects.toThrow();
        });

        it("returns an array of objects for the query", async () => {
          const results = await lodestone.pvpteam.find({
            dcname: "_dc_Light",
            q: "",
          });
